    ...
    async def detect_theme_command(cls, message: str) -> Optional[Tuple[str, Optional[str], str]]:
        ...
        for pattern in self.THEME_PATTERNS['switch_theme']:
            ...
            if match:
                ...
                # Check aliases
                theme_name = self.THEME_ALIASES.get(potential_theme.lower())
                if theme_name:
